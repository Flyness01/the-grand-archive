...
export const finaleHints = [
  ...
  "Crescent Context Card, star Flow Trace, bowl Alignment Note, toothed Incident Review, teardrop Release Record, five-point Star Chart, triangle Prism, and square Blueprint.",
];
