    ...
    <div className="journey-backdrop" onMouseDown={onClose}>
      ...
      >
        <header className="journey-thread__header">
          <div>
            <small>Internship workspace</small>
            <h2 id="journey-title"># intern-journey</h2>
            <p>Your summer, told through the messages that mattered.</p>
          </div>
          <button onClick={onClose} aria-label="Close internship journey">×</button>
        </header>
        ...
        <div className="journey-thread__messages">
          <div className="journey-date"><span />Your internship began<span /></div>
